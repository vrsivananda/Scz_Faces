function currentSubject3DPlotData = extract3DPlotData(dataStructure, subjectNumber ,subjectOrPatient)
    ...
    if(saveFigure)
        ...
        savingFileName = [subjectOrPatient '_' num2str(subjectNumber) '_3DPlot.jpg'];
