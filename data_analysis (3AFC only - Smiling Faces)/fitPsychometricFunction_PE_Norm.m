function [paramValues, chosenFaces] = fitPsychometricFunction_PE_Norm(dataStructure, subjectNumber, subjectOrPatient, saveFigure)
...
%     lowPE_lowNorm_converged = sum(lowPE_lowNorm_converged);
    ...
    if(saveFigure)
        ...
        savingFileName = [subjectOrPatient '_' num2str(subjectNumber) '_PE_Norm_PF.jpg'];
   ...
   chosenFaces = [targetCounter_highPE_highNorm, nontargetCounter_highPE_highNorm, distractorCounter_highPE_highNorm, mean(confidence_highPE_highNorm_Array, 'omitnan'); ...
                  targetCounter_highPE_lowNorm , nontargetCounter_highPE_lowNorm , distractorCounter_highPE_lowNorm , mean(confidence_highPE_lowNorm_Array, 'omitnan') ; ...
                  targetCounter_lowPE_highNorm , nontargetCounter_lowPE_highNorm , distractorCounter_lowPE_highNorm , mean(confidence_lowPE_highNorm_Array, 'omitnan') ; ...
                  targetCounter_lowPE_lowNorm  , nontargetCounter_lowPE_lowNorm  , distractorCounter_lowPE_lowNorm  , mean(confidence_lowPE_lowNorm_Array, 'omitnan')   ];
